...
public enum VfpCompatibility1_8 {
    ...
    private UserConnection getPlayNetworkUserConnection() {
        try {
            return (UserConnection) Class.forName("de.florianmichael.viafabricplus.protocoltranslator.ProtocolTranslator")
                    .getMethod("getPlayNetworkUserConnection")
                    .invoke(null);
        } catch (ReflectiveOperationException exception) {
            throw new IllegalStateException("ViaFabricPlus ProtocolTranslator is not available", exception);
        }
    }
