...
internal object FlyVerusB3896Damage : Choice("VerusB3896Damage") {
    ...
    override fun enable() {
        network.send(PlayerMoveC2SPacket.PositionAndOnGround(player.x, player.y, player.z, false))
        network.send(PlayerMoveC2SPacket.PositionAndOnGround(player.x, player.y + 3.25, player.z, false))
        network.send(PlayerMoveC2SPacket.PositionAndOnGround(player.x, player.y, player.z, false))
        network.send(PlayerMoveC2SPacket.PositionAndOnGround(player.x, player.y, player.z, true))
    }
