...
internal object FlyVulcan286Teleport : Choice("Vulcan286-Teleport-18") {
    ...
    val repeatable = repeatable {
        ...
        network.send(PositionAndOnGround(player.x, player.y - 0.1, player.z, player.isOnGround))
        ...
        repeat(3) {
            ...
            network.send(PositionAndOnGround(player.x, player.y, player.z, player.isOnGround))
        }
