...
class JcefTab(
    ...
    private val mcefBrowser: MCEFBrowser = MCEF.createBrowser(
        url,
        true,
    ...
    fun getTextureLocation(): Identifier = mcefBrowser.textureLocation

    fun isTextureReady(): Boolean = mcefBrowser.isTextureReady

    fun getTextureWidth(): Int = mcefBrowser.renderer.textureWidth

    fun getTextureHeight(): Int = mcefBrowser.renderer.textureHeight
