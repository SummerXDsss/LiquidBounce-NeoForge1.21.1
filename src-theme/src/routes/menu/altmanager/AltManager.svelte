...
<Menu>
    <OptionBar>
        ...
        <MultiSelect title="账号类型" options={["Mojang", "TheAltening", "EasyMC"]} bind:values={accountTypes}/>
    </OptionBar>
            ...
            {#each renderedAccounts as account}
                <MenuListItem
                    ...
                    <svelte:fragment slot="tag">
                        <MenuListItemTag text={accountTypeLabel(account.type)}/>
                    </svelte:fragment>
    ...
    <BottomButtonWrapper>
        <ButtonContainer>
            ...
            <IconTextButton icon="icon-plane.svg" title="直登" on:click={() => directLoginModalVisible = true}/>
