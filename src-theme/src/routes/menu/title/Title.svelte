    ...
    onMount(() => {
        setTimeout(async () => {
            ...
            if (update.updateAvailable) {
                notification.set({
                    title: `LiquidBounce ${update.newestVersion?.clientVersion} 已发布！`,
                    message: `请前往 github.com/summerxdsss 查看。`,
                    error: false,
                    delay: 99999999
                });
            }
    ...
    <div class="content">
        ...
        <div class="additional-buttons" transition:fly|global={{duration: 700, y: 100}}>
            <ButtonContainer>
                ...
                <IconTextButton icon="icon-change-background.svg" title="切换背景"
